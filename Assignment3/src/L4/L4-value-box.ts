...
export type Value = SExpValue | Closure | TracedClosure | void 
  // HW3
...
export const makeTracedClosure = (clo: Closure, name: string): TracedClosure =>
    // complete this
    ({tag: "TracedClosure", clo,name})
...
export const isSExp = (x: any): x is SExpValue =>
    ...
    isSymbolSExp(x) || isCompoundSExp(x) || isEmptySExp(x) || isPrimOp(x) || isClosure(x) || isTraceClosure(x);
